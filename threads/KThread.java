...
public class KThread {
	...
	/**
	 * Wake all the threads that have joined to this thread and remove them from this threads joined threads set.
	 */
	private void unjoin() {
	...
	public void join() {
		if (status == statusFinished) {
			...
			// join must be an atomic operation
			boolean intStatus = Machine.interrupt().disable();
